...
function makeDict(ruleset) {
  ...
  var previousSelectors = /* record */[/* contents */Belt_SetString.empty];
  var newStyle = Belt_List.reduce(ruleset, /* [] */0, (function (accStyle, curr) {
          var newAddition = toJs(curr);
          var name = newAddition[0];
          if (Belt_SetString.has(previousSelectors[0], name)) {
            return Belt_List.add(accStyle, /* :: */[
                        newAddition,
                        /* [] */0
                      ]);
          } else {
            var newStyles = accStyle ? Pervasives.$at(/* :: */[
                    Belt_List.add(accStyle[0], newAddition),
                    /* [] */0
                  ], accStyle[1]) : /* :: */[
                /* :: */[
                  newAddition,
            ...
            previousSelectors[0] = Belt_SetString.add(previousSelectors[0], name);
            return newStyles;
          }
        }));
  return Belt_List.toArray(Belt_List.reverse(Belt_List.map(newStyle, (function (x) {
                        return Js_dict.fromArray(Belt_List.toArray(x));
                      }))));
}
...
function style(rules) {
  return Emotion.css(makeDict(rules));
}
